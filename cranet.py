...
class DAN(nn.Module):
    ...
    def hash(self, x):
        out_fc1_1 = F.leaky_relu(self.fc1_1(x))
        out_fc1_2 = F.leaky_relu(self.fc1_2(out_fc1_1))
        sum_1 = x + out_fc1_2

        out_fc2_1 = F.leaky_relu(self.fc2_1(sum_1))
        out_fc2_2 = F.leaky_relu(self.fc2_2(out_fc2_1))
    ...
    def forward(self, x = None, target_data = None, lsh = None, labels = None):
        out_fc1_1 = F.leaky_relu(self.fc1_1(F.dropout(x, p=0.0)))
        out_fc1_2 = F.leaky_relu(self.fc1_2(out_fc1_1))
        sum_1 = x + out_fc1_2

        out_fc2_1 = F.leaky_relu(self.fc2_1(F.dropout(sum_1, p=0.0)))
        out_fc2_2 = F.leaky_relu(self.fc2_2(out_fc2_1))
        sum_2 = out_fc2_2 + sum_1 + x
        ...
        loss =  loss_regression + loss_classification + loss_lsh - loss_kl
